...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'numCompte', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'solde', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'depots', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'retraits', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'rechargments', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'agence', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'adminSyst', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'archivage'];
        }
     ...
     * {@inheritDoc}
     */
    public function addDepot(\App\Entity\Transaction $depot): \App\Entity\Compte
    {
     ...
     * {@inheritDoc}
     */
    public function removeDepot(\App\Entity\Transaction $depot): \App\Entity\Compte
    {
     ...
     * {@inheritDoc}
     */
    public function addRetrait(\App\Entity\Transaction $retrait): \App\Entity\Compte
    {
     ...
     * {@inheritDoc}
     */
    public function removeRetrait(\App\Entity\Transaction $retrait): \App\Entity\Compte
    {
     ...
     * {@inheritDoc}
     */
    public function getRechargments(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRechargments', []);

        return parent::getRechargments();
    }

    /**
     * {@inheritDoc}
     */
    public function addRechargment(\App\Entity\Depot $rechargment): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRechargment', [$rechargment]);

        return parent::addRechargment($rechargment);
    }

    /**
     * {@inheritDoc}
     */
    public function removeRechargment(\App\Entity\Depot $rechargment): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRechargment', [$rechargment]);

        return parent::removeRechargment($rechargment);
    }
     ...
     * {@inheritDoc}
     */
    public function getAdminSyst(): ?\App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdminSyst', []);

        return parent::getAdminSyst();
    }

    /**
     * {@inheritDoc}
     */
    public function setAdminSyst(?\App\Entity\User $adminSyst): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdminSyst', [$adminSyst]);

        return parent::setAdminSyst($adminSyst);
    }
     ...
     * {@inheritDoc}
     */
    public function setArchivage(bool $archivage): \App\Entity\Compte
    {
